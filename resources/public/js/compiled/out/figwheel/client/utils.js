...
return (new CustomEvent(event_name,(function (){var obj47282 = {"detail":data};
return obj47282;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__44085__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__44085__auto__)){
var and__44085__auto____$1 = (window["CustomEvent"]);
...
var args47287 = [];
var len__45172__auto___47293 = arguments.length;
var i__45173__auto___47294 = (0);
while(true){
if((i__45173__auto___47294 < len__45172__auto___47293)){
args47287.push((arguments[i__45173__auto___47294]));

var G__47295 = (i__45173__auto___47294 + (1));
i__45173__auto___47294 = G__47295;
continue;
} else {
}
break;
...
var f = (function (){var pred__47290 = cljs.core._EQ_;
var expr__47291 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__47290.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__47291))){
return ((function (pred__47290,expr__47291){
return (function (p1__47283_SHARP_){
return console.warn(p1__47283_SHARP_);
});
;})(pred__47290,expr__47291))
} else {
if(cljs.core.truth_(pred__47290.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__47291))){
return ((function (pred__47290,expr__47291){
return (function (p1__47284_SHARP_){
return console.debug(p1__47284_SHARP_);
});
;})(pred__47290,expr__47291))
} else {
if(cljs.core.truth_(pred__47290.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__47291))){
return ((function (pred__47290,expr__47291){
return (function (p1__47285_SHARP_){
return console.error(p1__47285_SHARP_);
});
;})(pred__47290,expr__47291))
} else {
return ((function (pred__47290,expr__47291){
return (function (p1__47286_SHARP_){
return console.log(p1__47286_SHARP_);
});
;})(pred__47290,expr__47291))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__47297){
var map__47300 = p__47297;
...
var opts = map__47300__$1;
var eval_fn = cljs.core.get.call(null,map__47300__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__47302_SHARP_);
});})(new_def))
);
...
return (function (p__47303){
var vec__47304 = p__47303;
var ky = cljs.core.nth.call(null,vec__47304,(0),null);
var v = cljs.core.nth.call(null,vec__47304,(1),null);
...
var args47307 = [];
var len__45172__auto___47310 = arguments.length;
var i__45173__auto___47311 = (0);
while(true){
if((i__45173__auto___47311 < len__45172__auto___47310)){
args47307.push((arguments[i__45173__auto___47311]));

var G__47312 = (i__45173__auto___47311 + (1));
i__45173__auto___47311 = G__47312;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args47307.length)].join('')));
...
if(cljs.core.truth_((function (){var and__44085__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1489402285590