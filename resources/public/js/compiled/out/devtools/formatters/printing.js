...
var len__45172__auto___57300 = arguments.length;
var i__45173__auto___57301 = (0);
while(true){
if((i__45173__auto___57301 < len__45172__auto___57300)){
args__45179__auto__.push((arguments[i__45173__auto___57301]));

var G__57302 = (i__45173__auto___57301 + (1));
i__45173__auto___57301 = G__57302;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__45180__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq57297){
var G__57298 = cljs.core.first.call(null,seq57297);
var seq57297__$1 = cljs.core.next.call(null,seq57297);
var G__57299 = cljs.core.first.call(null,seq57297__$1);
var seq57297__$2 = cljs.core.next.call(null,seq57297__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__57298,G__57299,seq57297__$2);
});
...
if(cljs.core.truth_((function (){var or__44097__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__44703__auto__,writer__44704__auto__,opt__44705__auto__){
return cljs.core._write.call(null,writer__44704__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__44085__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__44085__auto__){
var or__44097__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__44097__auto__)){
return or__44097__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__57303_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__57303_SHARP_));
})))){
...
var map__57312 = opts;
var map__57312__$1 = ((((!((map__57312 == null)))?((((map__57312.cljs$lang$protocol_mask$partition0$ & (64))) || (map__57312.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__57312):map__57312);
var markup_db = cljs.core.get.call(null,map__57312__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__44097__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e57316){var e__54683__auto__ = e57316;
return false;
}})();
if(cljs.core.truth_(or__44097__auto__)){
return or__44097__auto__;
...
}catch (e57318){var e__54683__auto__ = e57318;
return false;
}}
})())){
...
var _STAR_current_state_STAR_57323 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__57324 = opts;
var map__57324__$1 = ((((!((map__57324 == null)))?((((map__57324.cljs$lang$protocol_mask$partition0$ & (64))) || (map__57324.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__57324):map__57324);
var markup_db = cljs.core.get.call(null,map__57324__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_57323;
}});
...
;
var temp__4655__auto___57329 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___57329)){
var managed_print_level_57330 = temp__4655__auto___57329;
var _STAR_print_level_STAR_57328_57331 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_57330;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_57328_57331,managed_print_level_57330,temp__4655__auto___57329,writer,opts,job_fn){
return (function (p1__57326_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__57326_SHARP_,null);
});})(_STAR_print_level_STAR_57328_57331,managed_print_level_57330,temp__4655__auto___57329,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_57328_57331;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1489402293077