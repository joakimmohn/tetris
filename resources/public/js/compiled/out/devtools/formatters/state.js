...
var len__45172__auto___57291 = arguments.length;
var i__45173__auto___57292 = (0);
while(true){
if((i__45173__auto___57292 < len__45172__auto___57291)){
args__45179__auto__.push((arguments[i__45173__auto___57292]));

var G__57293 = (i__45173__auto___57292 + (1));
i__45173__auto___57292 = G__57293;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45180__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq57289){
var G__57290 = cljs.core.first.call(null,seq57289);
var seq57289__$1 = cljs.core.next.call(null,seq57289);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__57290,seq57289__$1);
});
...
return (p1__57294_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1489402293002