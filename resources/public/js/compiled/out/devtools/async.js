...
var o__54658__auto___58043 = (function (){var o__54658__auto__ = (function (){var o__54658__auto__ = Promise;
return goog.object.get(o__54658__auto__,"resolve").call(o__54658__auto__);
})();
return goog.object.get(o__54658__auto__,"then").call(o__54658__auto__,callback);
})();
goog.object.get(o__54658__auto___58043,"catch").call(o__54658__auto___58043,devtools.async.rethrow_outside_promise);
...
var G__58045_58046 = Error;
var target__54677__auto___58047 = G__58045_58046;
if(cljs.core.truth_(target__54677__auto___58047)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__58045_58046)].join('')),cljs.core.str("\n"),cljs.core.str("target__54677__auto__")].join('')));
}

goog.object.set(target__54677__auto___58047,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1489402293809