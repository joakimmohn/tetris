...
var temp__4657__auto____$1 = goog.object.get(o__54671__auto__,"core");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__54670__auto__ = temp__4657__auto____$1;
return goog.object.get(o__54670__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__54658__auto__ = f;
return goog.object.get(o__54658__auto__,"toString").call(o__54658__auto__);
}catch (e57113){var _ = e57113;
return "";
}});
...
try{var o__54658__auto___57116 = t;
goog.object.get(o__54658__auto___57116,"cljs$lang$ctorPrWriter").call(o__54658__auto___57116,t,writer);
}catch (e57115){var __57117 = e57115;
}
...
var char_code = (function (){var o__54658__auto__ = (new String(char$));
return goog.object.get(o__54658__auto__,"charCodeAt").call(o__54658__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__54658__auto__ = String;
return goog.object.get(o__54658__auto__,"fromCharCode").call(o__54658__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__57119 = num_code;
switch (G__57119) {
case (1):
return (185);
...
var o__54658__auto__ = String;
return goog.object.get(o__54658__auto__,"fromCharCode").call(o__54658__auto__,superscript_code);
});
/**
...
}catch (e57125){var e__54683__auto__ = e57125;
return false;
}})())){
...
var vec__57126 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__57126,(0),null);
...
var or__44097__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4657__auto__)){
var o__54671__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__54671__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__54670__auto__ = temp__4657__auto____$1;
return goog.object.get(o__54670__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__45172__auto___57135 = arguments.length;
var i__45173__auto___57136 = (0);
while(true){
if((i__45173__auto___57136 < len__45172__auto___57135)){
args__45179__auto__.push((arguments[i__45173__auto___57136]));

var G__57137 = (i__45173__auto___57136 + (1));
i__45173__auto___57136 = G__57137;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45180__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__57131){
var vec__57132 = p__57131;
var ns_detector = cljs.core.nth.call(null,vec__57132,(0),null);
var effective_detector = (function (){var or__44097__auto__ = ns_detector;
if(cljs.core.truth_(or__44097__auto__)){
return or__44097__auto__;
} else {
...
var G__57138 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__57139 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__57138;
remaining_tokens = G__57139;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq57129){
var G__57130 = cljs.core.first.call(null,seq57129);
var seq57129__$1 = cljs.core.next.call(null,seq57129);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__57130,seq57129__$1);
});
...
var vec__57147 = cljs.core.split_with.call(null,(function (p1__57143_SHARP_){
return cljs.core.not_EQ_.call(null,p1__57143_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__57147,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__57147,(1),null);
...
var vec__57153 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__57153,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__57153,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__57156 = cljs.core.rest.call(null,remaining_tokens);
var G__57157 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__57156;
name_tokens = G__57157;
continue;
} else {
...
var args57158 = [];
var len__45172__auto___57170 = arguments.length;
var i__45173__auto___57171 = (0);
while(true){
if((i__45173__auto___57171 < len__45172__auto___57170)){
args57158.push((arguments[i__45173__auto___57171]));

var G__57172 = (i__45173__auto___57171 + (1));
i__45173__auto___57171 = G__57172;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args57158.length)].join('')));
...
var vec__57161 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__57161,(0),null);
var arity = cljs.core.nth.call(null,vec__57161,(1),null);
var vec__57164 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__57164,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__57164,(1),null);
var vec__57167 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__57167,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__57167,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__57167,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__57167,(3),null);
...
var args57174 = [];
var len__45172__auto___57180 = arguments.length;
var i__45173__auto___57181 = (0);
while(true){
if((i__45173__auto___57181 < len__45172__auto___57180)){
args57174.push((arguments[i__45173__auto___57181]));

var G__57182 = (i__45173__auto___57181 + (1));
i__45173__auto___57181 = G__57182;
continue;
} else {
}
break;
...
var vec__57177 = result;
var munged_ns = cljs.core.nth.call(null,vec__57177,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__57177,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__57177,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__57177,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__57177,(4),null);
var arity = cljs.core.nth.call(null,vec__57177,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__57190 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__57190,(0),null);
var args = cljs.core.nth.call(null,vec__57190,(1),null);
var vec__57193 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__57193,(0),null);
var name = cljs.core.nth.call(null,vec__57193,(1),null);
...
var G__57196 = (arity + (1));
var G__57197 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__57198){
var vec__57202 = p__57198;
var arity = cljs.core.nth.call(null,vec__57202,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__57202,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__44097__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__44097__auto__)){
return or__44097__auto__;
} else {
...
return (function (p1__57205_SHARP_){
return cljs.core.get.call(null,arities,p1__57205_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__57206_SHARP_);
...
var args__45179__auto__ = [];
var len__45172__auto___57213 = arguments.length;
var i__45173__auto___57214 = (0);
while(true){
if((i__45173__auto___57214 < len__45172__auto___57213)){
args__45179__auto__.push((arguments[i__45173__auto___57214]));

var G__57215 = (i__45173__auto___57214 + (1));
i__45173__auto___57214 = G__57215;
continue;
} else {
}
break;
...
var argseq__45180__auto__ = ((((1) < args__45179__auto__.length))?(new cljs.core.IndexedSeq(args__45179__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45180__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__57209){
var vec__57210 = p__57209;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__57210,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq57207){
var G__57208 = cljs.core.first.call(null,seq57207);
var seq57207__$1 = cljs.core.next.call(null,seq57207);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__57208,seq57207__$1);
});
...
var G__57217 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__57217) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__44097__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__44097__auto__)){
return or__44097__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__44085__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__44097__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__44097__auto__)){
return or__44097__auto__;
} else {
...
var map__57224 = options;
var map__57224__$1 = ((((!((map__57224 == null)))?((((map__57224.cljs$lang$protocol_mask$partition0$ & (64))) || (map__57224.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__57224):map__57224);
var include_ns_QMARK_ = cljs.core.get.call(null,map__57224__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__57224__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__57224__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__57224__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__57225 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__57225,(0),null);
var fn_name = cljs.core.nth.call(null,vec__57225,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__57225,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__57225,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__57225,(4),null);
var arity = cljs.core.nth.call(null,vec__57225,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__44085__auto__ = protocol_ns;
if(cljs.core.truth_(and__44085__auto__)){
return cljs.core.not.call(null,(function (){var and__44085__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__44097__auto__ = protocol_part;
if(cljs.core.truth_(or__44097__auto__)){
return or__44097__auto__;
} else {
return fn_part;
...
var o__54658__auto__ = f;
return goog.object.get(o__54658__auto__,"getBasis").call(o__54658__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__44085__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__44085__auto__)){
...
}catch (e57230){var e__54683__auto__ = e57230;
...
var G__57231 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__57232 = cljs.core.rest.call(null,path);
obj = G__57231;
path = G__57232;
continue;
} else {
...
var partition_bits = (function (){var or__44097__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__44097__auto__)){
return or__44097__auto__;
} else {
return (0);
...
return (function (accum,p__57237){
var vec__57238 = p__57237;
var bit = cljs.core.nth.call(null,vec__57238,(0),null);
var protocol = cljs.core.nth.call(null,vec__57238,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__57241){
var vec__57245 = p__57241;
var ns = cljs.core.nth.call(null,vec__57245,(0),null);
var name = cljs.core.nth.call(null,vec__57245,(1),null);
var selector = cljs.core.nth.call(null,vec__57245,(2),null);
...
return (function (p__57253){
var vec__57254 = p__57253;
var munged_name = cljs.core.nth.call(null,vec__57254,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__57254,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__57254,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__57248_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__57248_SHARP_));
});})(name,sorted_matches,vec__57254,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1489402292882