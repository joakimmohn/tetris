...
var reader = (function (){var or__44097__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__44097__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__44097__auto__)){
return or__44097__auto__;
} else {
return (128);
...
var map__58070 = top_item;
var map__58070__$1 = ((((!((map__58070 == null)))?((((map__58070.cljs$lang$protocol_mask$partition0$ & (64))) || (map__58070.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__58070):map__58070);
var file = cljs.core.get.call(null,map__58070__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__58070__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__58070__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e58069){var _e = e58069;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___58072 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___58072)){
var seen_errors_58073 = temp__4655__auto___58072;
if(cljs.core.truth_(seen_errors_58073.has(self))){
} else {
seen_errors_58073.add(self);

var temp__4657__auto___58074 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___58074)){
var sense_58075 = temp__4657__auto___58074;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_58075)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1489402293888