...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__44703__auto__,writer__44704__auto__,opt__44705__auto__){
return cljs.core._write.call(null,writer__44704__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__58505 = o;
(G__58505[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__58506__delegate = function (args){
...
while (G__58507__i < G__58507__a.length) {G__58507__a[G__58507__i] = arguments[G__58507__i + 0]; ++G__58507__i;}
  args = new cljs.core.IndexedSeq(G__58507__a,0);
} 
return G__58506__delegate.call(this,args);};
G__58506.cljs$lang$maxFixedArity = 0;
G__58506.cljs$lang$applyTo = (function (arglist__58508){
var args = cljs.core.seq(arglist__58508);
return G__58506__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__44085__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__44085__auto__){
var and__44085__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__58513 = jsprops;
(G__58513["defaultValue"] = value);

(G__58513["onChange"] = ((function (G__58513,v,value,on_change){
return (function (p1__58511_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__58511_SHARP_);
});})(G__58513,v,value,on_change))
);
...
var vec__58520 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__58520,(0),null);
var id = cljs.core.nth.call(null,vec__58520,(1),null);
var class$ = cljs.core.nth.call(null,vec__58520,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___58525 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___58525 == null)){
} else {
var key_58526 = temp__4661__auto___58525;
(jsprops["key"] = key_58526);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__58528 = (new reagent.impl.template.NativeWrapper());
(G__58528["name"] = c);
...
var len__45172__auto___58534 = arguments.length;
var i__45173__auto___58535 = (0);
while(true){
if((i__45173__auto___58535 < len__45172__auto___58534)){
args__45179__auto__.push((arguments[i__45173__auto___58535]));

var G__58536 = (i__45173__auto___58535 + (1));
i__45173__auto___58535 = G__58536;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45180__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq58532){
var G__58533 = cljs.core.first.call(null,seq58532);
var seq58532__$1 = cljs.core.next.call(null,seq58532);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__58533,seq58532__$1);
});
...
break;
default:
var G__58540 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__58540;
continue;
...
var n__45012__auto___58543 = a.length;
var i_58544 = (0);
while(true){
if((i_58544 < n__45012__auto___58543)){
(a[i_58544] = reagent.impl.template.as_element.call(null,(a[i_58544])));

var G__58545 = (i_58544 + (1));
i_58544 = G__58545;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__45012__auto___58546 = a.length;
var i_58547 = (0);
while(true){
if((i_58547 < n__45012__auto___58546)){
var val_58548 = (a[i_58547]);
if((cljs.core.vector_QMARK_.call(null,val_58548)) && ((reagent.impl.template.key_from_vec.call(null,val_58548) == null))){
(o["no-key"] = true);
} else {
}

(a[i_58547] = reagent.impl.template.as_element.call(null,val_58548));

var G__58549 = (i_58547 + (1));
i_58547 = G__58549;
continue;
} else {
}
...
var ctx = ({});
var vec__58553 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__58553,(0),null);
var derefed = cljs.core.nth.call(null,vec__58553,(1),null);
...
var G__58557 = (cljs.core.count.call(null,argv) - first_child);
switch (G__58557) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__58557){
...
//# sourceMappingURL=template.js.map?rel=1489402385813